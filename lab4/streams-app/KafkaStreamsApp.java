...
public class KafkaStreamsApp {
    public static void main(String[] args) {
        ...
        // c. Найпопулярніша початкова станція
        resultStream.mapValues(DailyAggregate::getMostPopularStart).to("topic-popular-start", Produced.with(Serdes.String(), Serdes.String()));
